...
Run only AFTER setup_ollama.py has finished (server running, custom
model created).
"""
...
MODEL_NAME = "qa-assistant"  # custom model created by setup_ollama.py, has the system prompt baked in
